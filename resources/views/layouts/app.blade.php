                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-event"></i><span> Customers </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-event"></i><span> Suppliers </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
